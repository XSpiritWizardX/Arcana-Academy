...
def seed_reviews():
    ...
    review5 = Review(
        user_id=1, title='Excellent Wand', rating=5, description="This wand is fantastic! It has a beautiful design and works perfectly. I would highly recommend it to anyone looking for a new wand.")
    review6 = Review(
        user_id=1, title='Poor Wand', rating=1, description="This wand is terrible. It feels cheap and doesn't work at all. I would not recommend it to anyone.")
    review7 = Review(
        user_id=1, title='Decent Wand', rating=3, description="This wand is decent. It works well enough, but I expected more from it. The design is nice, but it could be more powerful.")
    review8 = Review(
